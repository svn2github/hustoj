...
//echo $sql;
  ...
  if(isset($_SESSION[$OJ_NAME.'_'.'administrator'])){
  	$sql="select count(sp) sp from (select  avg(1) sp,judgetime from solution where result>3 and judgetime>date_sub(now(),interval 1 hour)  group by (judgetime DIV 60 * 60) order by sp) tt;";
