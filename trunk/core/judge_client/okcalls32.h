 ...
 */
//c & c++
int LANG_CV[CALL_ARRAY_SIZE] = {3,4,8,11,33,45,85,122,140,146,192,197,243,252,272,SYS_time, SYS_read, SYS_uname, SYS_write, SYS_open,
...
//python
int LANG_YV[CALL_ARRAY_SIZE]={3,4,5,6,11,33,45,54,85,116,122,125,140,174,175,183,
