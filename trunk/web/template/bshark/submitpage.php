...
<?php if($OJ_ACE_EDITOR){ ?>
	<pre style="width:80%;height:600;font-size:15px" cols=180 rows=20 id="source"><?php echo htmlentities($view_src,ENT_QUOTES,"UTF-8")?></pre><br>
...
<div class="row">
<?php echo $MSG_Input?>:<textarea class="form-control" style="width:30%" cols=40 rows=5 id="input_text" name="input_text" ><?php echo $view_sample_input?></textarea>
<label><?php echo $MSG_Output?>:</label>
<textarea class="form-control" style="width:30%" cols=10 rows=5 id="out" name="out" disabled="true" ><?php echo $view_sample_output?>
</textarea>
</div>
<br>
<?php } ?>
<input id="Submit" class="btn btn-outline-success" type=button value="<?php echo $MSG_SUBMIT?>" onclick="do_submit();" >
