...
apt-get install -y make flex g++ clang libmysqlclient-dev libmysql++-dev php-fpm nginx mysql-server php-mysql  php-common php-xml-parser php-gd php-zip fp-compiler openjdk-11-jdk mono-devel php-mbstring php-xml
