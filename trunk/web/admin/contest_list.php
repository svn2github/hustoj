...
echo "<tr><td>ContestID<td>Title<td>StartTime<td>EndTime<td>Private<td>Delete<td>Edit<td>Copy<td></tr>";
for (;$row=mysql_fetch_object($result);){
	...
	echo "<td><a href=contest_df_change.php?cid=$row->contest_id&getkey=".$_SESSION['getkey'].">".($row->defunct=="N"?"Delete":"Resume")."</a>";
