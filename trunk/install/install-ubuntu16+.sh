...
apt-get install -y make flex g++ clang libmysqlclient-dev libmysql++-dev php-fpm php-memcache memcached nginx mysql-server php-mysql php-gd php-zip fp-compiler openjdk-8-jdk mono-devel php-mbstring php-xml
