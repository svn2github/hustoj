...
================================================== -->
    ...
    var board = new Board(<?php echo $problem_num?>, new Array(<?php echo $gold_num?>, <?php echo $silver_num?>,
        <?php echo $bronze_num?>), StringToDate("<?php echo  $start_time_str?>"), StringToDate(
        "<?php echo $lock_time_str?>"), <?php echo $cid?>);
