...
<table id=rank class="table table-hover"><thead><tr class=toprow align=center><td class="{sorter:'false'}">Rank<th width=10%>User</th><th>Nick</th><th>Solved</th><th>Penalty</th>
<?php
$rank=1;
for ($i=0;$i<$pid_cnt;$i++)
