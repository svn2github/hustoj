...
Blockly.Msg.MATH_ROUND_OPERATOR_FLOAT = "cast to float";  // untranslated
Blockly.Msg.MATH_ROUND_OPERATOR_INT = "cast to int";  // untranslated
...
Blockly.Msg.MATH_TO_NUMBER_TOOLTIP = "cast text to number for calculation";  // untranslated
