...
//C C++
int LANG_CV[CALL_ARRAY_SIZE]={0,1,3,4,5,16,27,33,43,45,56,80,85,122,136,152,176,192,197,208,216,224,248,312,344,360,363,368,384,432,504,0};
//pascal
int LANG_PV[CALL_ARRAY_SIZE] = {0,3,4,54,85,174,191,248,0};
//java
int LANG_JV[CALL_ARRAY_SIZE] ={0,2,3,5,6,19,33,45,85,91,120,122,125,174,175,191,192,195,197,240,248,256,338,0};
//ruby
