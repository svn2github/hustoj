...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <?php require("./template/bshark/header-files.php");?><style>h4{margin-top: 10px;margin-bottom: 10px;font-size:24px;}</style>
    </head>
        		...
        		<div class="card">
  					<div class="card-body">
						...
						<div id="qwqs1">
							<?php 
								if (strlen($sinput)) {
									?><h4><?php echo $MSG_Sample_Input;?><a class="btn btn-outline-primary btn-sm" href="#" id="qwqa1">复制</a></h4><blockquote id="sampleInput"><pre><?php
						...
						<div id="qwqs2">
							<?php 
								if (strlen($soutput)) {
									?><h4><?php echo $MSG_Sample_Output;?><a class="btn btn-outline-primary btn-sm" href="#" id="qwqa2">复制</a></h4><blockquote id="sampleOutput"><pre><?php
			...
			<div class="col-md-4">
				<div class="card" style="padding: 0;">
					<div class="list-group list-group-flush">
  						<a href="<?php if ( $pr_flag ) { echo "submitpage.php?id=$id";} else { echo "submitpage.php?cid=$cid&pid=$pid&langmask=$langmask";}?>" class="list-group-item list-group-item-action" aria-current="true">
							<?php echo $MSG_SUBMIT;?>
						</a>
  						<a href="<?php echo "status.php?problem_id=" . $row[ 'problem_id' ];?>" class="list-group-item list-group-item-action"><?php echo $MSG_STATUS;?></a>
						<?php 
						if ( isset( $_SESSION[ $OJ_NAME . '_' . 'administrator' ] )||isset($_SESSION[$OJ_NAME.'_'.'problem_manager']) ) {
											require_once( "include/set_get_key.php" );
						?> 
						<a href="bsadmin/problem_edit.php?id=<?php echo $id?>&getkey=<?php echo $_SESSION[$OJ_NAME.'_'.'getkey']?>" class="list-group-item list-group-item-action"><?php echo $MSG_EDIT;?></a>
						<a href='javascript:phpfm(<?php echo $row['problem_id'];?>)' class="list-group-item list-group-item-action"><?php echo $MSG_TESTDATA;?></a>
						<?php } ?>
					</div>
				</div>
				<br>
					...
					<div class="card-body">
						...
						<table class="table table-hover">
							<tr>
								...
								<td><?php echo $row['time_limit'];?>s</td>
							</tr>
							<tr>
							...
							<tr>
								<th>评测方式</th>
								<td><?php echo $row['spj']?"Special Judge":"Normal Judge";?></td>
							</tr>
						</table>
					</div>
				</div>
