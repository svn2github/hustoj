...
//C C++
int LANG_CV[256]={0,456,2,3,6,85,122,368,392,393,397,400,404,453,479,166,156,32,115,4,7,1,167,165,13,12,157,155,201,199,5,3,33,31,60,208,202,2,26,90,91,114,116,119,150,187,200,419,420,421,461,506,0};
//pascal
int LANG_PV[256] = {0,3,4,54,85,174,191,248,0};
//java
int LANG_JV[256]={0,2,3,10,24,25,26,29,32,40,89,98,99,117,119,142,150,156,168,187,192,195,213,232,248,419,421,422,427,435,440,449,461,463,465,466,492,501,506,507,0};
//ruby
int LANG_RV[256] = {0,0};
//bash
