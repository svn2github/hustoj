...
<div id=main class="span8 offset1">
        ...
        <?php if($OJ_VCODE){?>
                <tr><td><?php echo $MSG_VCODE?>:</td>
                        <td><input name="vcode" size=4 type=text style="height:24px"><img id="vcode-img" alt="click to change" onclick="this.src='vcode.php?'+Math.random()">*</td>
                </tr>
                <?php }?>
...
<div id=foot>
    ...
    <?php if ($OJ_VCODE) { ?>
        <script>
            document.getElementById("vcode-img").src="vcode.php?"+Math.random();
        </script>
    <?php } ?>
</div><!--end foot-->
</div><!--end main-->
