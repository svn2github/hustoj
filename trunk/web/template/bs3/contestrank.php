        ...
        <table id=rank>
          <thead>
            <tr class=toprow align=center>
              ...
              <th width=10%><?php echo $MSG_USER?></th>
              <th width=10%><?php echo $MSG_NICK?></th>
              <th width=5%><?php echo $MSG_SOVLED?></th>
              <th width=5%><?php echo $MSG_CONTEST_PENALTY?></th>
              <?php
              for ($i=0;$i<$pid_cnt;$i++) echo "<td><a href=problem.php?cid=$cid&pid=$i>$PID[$i]</a></td>";
              ?>
            </tr>
          </thead>
