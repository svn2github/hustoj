            ...
            <div class="padding">
                ...
                <form action="modify.php" method="post" role="form" class="ui form">
                    <div class="field">
                        ...
                        <input class="form-control" placeholder="请输入用户名" disabled="disabled" type="text"
                            value="<?php echo $_SESSION[$OJ_NAME . '_' . 'user_id'] ?>">
                    </div>
                    <?php require_once('./include/set_post_key.php'); ?>
                    <div class="field">
                        <label for="username">昵称*</label>
                        <input name="nick" placeholder="请输入昵称" type="text"
                    ...
                    <div class="field">
                        ...
                        <input name="school" placeholder="请输入个性签名" type="text"
                            value="<?php echo htmlentities($row['school'], ENT_QUOTES, "UTF-8") ?>">
                    </div>
                    <div class="field">
                        <label for="email">邮箱*</label>
                        <input name="email" placeholder="请输入邮箱" type="text"
                    ...
                    <?php } ?>
                    <button name="submit" type="submit" class="ui primary button">修改</button>
