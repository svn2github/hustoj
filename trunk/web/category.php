...
///////////////////////////MAIN	
	...
	if (!$result){
		...
		foreach ($category as $cat){
			...
			$view_category.= "<small><a class='label label-$label_theme' style='display: inline-block;' href='problemset.php?search=".urlencode(htmlentities($cat,ENT_QUOTES,'UTF-8'))."'>".$cat."</a></small>&nbsp;";
		}
