...
for PKG in make flex g++ clang libmysqlclient-dev libmysql++-dev php-fpm nginx php-mysql  php-common php-gd php-zip fp-compiler openjdk-11-jdk mono-devel php-mbstring php-xml mariadb-server libmariadb-dev libmariadbclient-dev libmariadb-dev default-libmysqlclient-dev
do
