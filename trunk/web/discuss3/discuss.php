...
for ($i=0;$i<$rows_cnt;$i++){
        ...
        if($row->cid)echo "<td><a href=\"thread.php?tid={$row->tid}&cid={$row->cid}\">".htmlentities($row->title,ENT_QUOTES)."</a></td>";
        else echo "<td><a href=\"thread.php?tid={$row->tid}\">".htmlentities($row->title,ENT_QUOTES)."</a></td>";
